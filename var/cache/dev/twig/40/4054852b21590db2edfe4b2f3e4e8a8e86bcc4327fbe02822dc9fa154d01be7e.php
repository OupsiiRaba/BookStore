...
class __TwigTemplate_3fce3ebc3e5bafb9d925ff5473a3fc142c06fe0017b5066eb6a3222538b36198 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "        <div class=\"mb-3\">
            Vous etes connectée en tant que  ";
            // line 13
        ...
        echo " <div class=\"row\">
                    <div class=\"col-6\">
                        <div class=\"form-group\">
                            <button type=\"submit\" class=\"btn btn-success\">Connexion</button> <button type=\"reset\" class=\"btn btn-secondary\">Annuler</button>
                        </div>
            </div>
                    </div>
</form>
...
";
    ...
    {
        return array (  121 => 39,  115 => 26,  107 => 21,  100 => 16,  92 => 13,  89 => 12,  87 => 11,  84 => 10,  78 => 8,  76 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block title %}Se connecter | Book Store{% endblock %}
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connectée en tant que  {{ app.user.email }}, <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\rabab\\Desktop\\blogStoreProject\\templates\\security\\login.html.twig");
    }
}
